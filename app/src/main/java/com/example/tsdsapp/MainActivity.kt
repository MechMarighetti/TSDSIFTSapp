...
class MainActivity : AppCompatActivity() {
    ...
    private var mockData = MateriasAlumno.generarMockData()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarMain.fab.setOnClickListener { view ->
            Snackbar.make(view, "No tiene notificaciones", Snackbar.LENGTH_LONG)
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_gallery, R.id.menu_logout, R.id.nav_calificaciones, R.id.nav_asistencia ), drawerLayout
        )
